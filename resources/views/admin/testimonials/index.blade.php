                    ...
                    <tbody class="table-border-bottom-0">
                        @foreach ($testimonials as $key => $testimonial)
                            <tr>
                                ...
                                <td class="">
                                    <a href="{{ asset('admin/images/testimonials/') }}/{{ $testimonial->image ?: 'avatar.png' }}"
                                        data-fancybox="demo" class="fancybox">
                                        <img src="{{ asset('admin/images/testimonials/') }}/{{ $testimonial->image ?: 'avatar.png' }}"
                                ...
                                <td>
                                    ...
                                    <form class="delete-form" action="{{ route('admin.testimonials.destroy', $testimonial->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
