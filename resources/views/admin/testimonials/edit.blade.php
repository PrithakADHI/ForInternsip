        ...
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end">
                    <a href="{{ route('admin.testimonials.index') }}" class="btn btn-primary"><i class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
            <div class="card-body">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    name="name" id="" value="{{ old('title', $testimonial->name) }}" placeholder="">
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="order" id="" value="{{ old('order', $testimonial->order) }}" placeholder=""
                                    autocomplete="off">
                                @error('order')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-6">
                                    ...
                                    @if ($testimonial->image)
                                        <img src="{{ asset('admin/images/testimonials/' . $testimonial->image) }}" width="100"
