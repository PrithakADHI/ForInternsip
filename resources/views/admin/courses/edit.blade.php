                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror"
                                    name="name" id="" value="{{ old('title', $course->name) }}" placeholder="">
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control"
                                    name="order" id="" value="{{ old('order', $course->order) }}" placeholder=""
                                    autocomplete="off">
                                @error('order')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                            ...
                            <div class="mb-3 row">
                                <div class="col-md-6">
                                    ...
                                    @if ($course->image)
                                        <img src="{{ asset('admin/images/courses/' . $course->image) }}" width="100"
